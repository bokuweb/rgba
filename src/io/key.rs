...
impl Key {
    ...
    pub(crate) const fn set_A(&mut self, s: KeyStatus) {
        self.0 = match s {
    ...
    pub(crate) const fn set_B(&mut self, s: KeyStatus) {
        self.0 = match s {
    ...
    pub(crate) const fn set_SELECT(&mut self, s: KeyStatus) {
        self.0 = match s {
    ...
    pub(crate) const fn set_START(&mut self, s: KeyStatus) {
        self.0 = match s {
    ...
    pub(crate) const fn set_RIGHT(&mut self, s: KeyStatus) {
        self.0 = match s {
    ...
    pub(crate) const fn set_LEFT(&mut self, s: KeyStatus) {
        self.0 = match s {
    ...
    pub(crate) const fn set_UP(&mut self, s: KeyStatus) {
        self.0 = match s {
    ...
    pub(crate) const fn set_DOWN(&mut self, s: KeyStatus) {
        self.0 = match s {
    ...
    pub(crate) const fn set_R(&mut self, s: KeyStatus) {
        self.0 = match s {
    ...
    pub(crate) const fn set_L(&mut self, s: KeyStatus) {
        self.0 = match s {
    ...
    pub(crate) const fn read(&self) -> HalfWord {
        // dbg!("----", self.0);
        self.0
    }
}
